...
public class test {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= 374; i++) {
            Mat source = Imgcodecs.imread("C:\\Users\\mpari\\Documents\\coding projects\\Java\\PiciticanyOpenCVProject\\OpenCV-9th-grade-Comp-Sci-Project\\OpenCV Pictures\\IMG_1383.jpg", Imgcodecs.IMREAD_GRAYSCALE ); //(" + i +")   THIS IS FOR THE FINAL IMAGE NAME when using multiple images loads in the image as grayscale - the i will change with each loop of the program, automatically running for each image
            Mat destination = new Mat(source.rows(), source.cols(), source.type());
            source.convertTo(destination, CvType.CV_8S);
            Imgcodecs.imwrite("C:\\Users\\mpari\\Documents\\coding projects\\Java\\PiciticanyOpenCVProject\\OpenCV-9th-grade-Comp-Sci-Project\\OpenCV Pictures\\IMG_1383GRAYSCALE.jpg", destination); //write the image as grayscale to a new file
            ...
            Mat last = Imgcodecs.imread("C:\\Users\\mpari\\Documents\\coding projects\\Java\\PiciticanyOpenCVProject\\OpenCV-9th-grade-Comp-Sci-Project\\OpenCV Pictures\\IMG_1383.jpg"); //Loads in the original image to crop
            Mat image_output  = last.submat(rectCrop); //applies to image
            Imgcodecs.imwrite("C:\\Users\\mpari\\Documents\\coding projects\\Java\\PiciticanyOpenCVProject\\OpenCV-9th-grade-Comp-Sci-Project\\OpenCV Pictures\\IMG1383ISTundCROPPED.jpg", image_output); //writes the final cropped image
            Mat croppedimage = Imgcodecs.imread("C:\\Users\\mpari\\Documents\\coding projects\\Java\\PiciticanyOpenCVProject\\OpenCV-9th-grade-Comp-Sci-Project\\OpenCV Pictures\\IMG1383ISTundCROPPED.jpg", Imgcodecs.IMREAD_GRAYSCALE );
            ...
            Imgcodecs.imwrite("C:\\Users\\mpari\\Documents\\coding projects\\Java\\PiciticanyOpenCVProject\\OpenCV-9th-grade-Comp-Sci-Project\\OpenCV Pictures\\IMG_1383CROPPEdGRAYSCALE.jpg", croppedgrayscale);
        }
    }
}